            ...
            <Group>
              {vid._id === id ? (
                <video ref={videoRef} controls className="video-player">
                  <source
                    src={"http://10.1.104.3:1205/" + vid.video}
                    type="video/mp4"
                    frameborder="0"
              ...
              <Group>
                {vid.user ? (
                  <>
                    ...
                    >
                      <img
                        src={"http://10.1.104.3:1205/" + vid.user.image}
                        alt="Login Picture"
                        style={{
                          width: "46px",
                          height: "46px",
            ...
            {cookies && cookies.currentUser ? (
              <>
                <Group style={{ paddingLeft: "12px" }}>
                  <img
                    src={"http://10.1.104.3:1205/" + cookies.currentUser.image}
                    alt="Login Picture"
                    style={{
                      width: "38px",
                      height: "38px",
              ...
              comments.map((com) => (
                <Grid.Col span={12}>
                  ...
                  <Group position="apart">
                    <Group>
                      <img
                        src={"http://10.1.104.3:1205/" + com.user.image}
                        alt="Login Picture"
                        style={{
                          width: "38px",
                          height: "38px",
